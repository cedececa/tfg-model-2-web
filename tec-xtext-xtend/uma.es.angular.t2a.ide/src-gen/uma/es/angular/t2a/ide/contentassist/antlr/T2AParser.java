...
public class T2AParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, T2AGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPageAccess().getShowInNavAssignment_4(), "rule__Page__ShowInNavAssignment_4");
			builder.put(grammarAccess.getPageAccess().getPageFeaturesAssignment_5(), "rule__Page__PageFeaturesAssignment_5");
			...
			builder.put(grammarAccess.getCompAccess().getFeaturesAssignment_2_1(), "rule__Comp__FeaturesAssignment_2_1");
